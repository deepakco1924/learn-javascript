...
//resusalbe piece code that eccapsulated implementation details
//compose software ->modules are builiing blocks to add to make software
//isolate components
//abstract code
//organized code
//reuse ocde
//importaning moduls variable are hoizted
//importing moduels synchronously //modules nt copy they got reference of important values
_shoppingJs.addTocart("bread", 5);
console.log(_shoppingJs.totalPrice);
//all imports are getting reference to exports
//using the awai outside the async blocking mode in both importing module and exporting module
(function() {
    const cart = [];
    const shippinCart = 10;
...
console.log(b);
console.log("deepak");
console.log("rate343ingrter 4534");

},{"./shopping.js":"8rnbv","./node_modules/lodash-es/cloneDeep.js":"dd5At","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8rnbv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const shippinCart = 10;
const cart = [];
//export named and defaults exportsn
let totalPrice = 237;
const addTocart = function(product, quantity) {
    cart.push({
        product,
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iL2AH","6rimH"], "6rimH", "parcelRequireb03a")
